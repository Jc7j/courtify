...
const success = (message: string, options?: ExtendedToastOptions) => {
...
const error = (message: string, options?: ExtendedToastOptions) => {
...
const warning = (message: string, options?: ExtendedToastOptions) => {
...
const info = (message: string, options?: ExtendedToastOptions) => {
...
export { Toaster, success, error, warning, info }
